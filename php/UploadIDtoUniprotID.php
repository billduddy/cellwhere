...
$IDfromUniprot = '';               // Initialize array to store all ACCs for all query IDs
...
switch ($ID_type) {                 // Depending on selection on dropdown menu
    case "GeneSymbol":
        foreach ( $ID_array as $key => $value ) {
            ...
            $TheseIDs = '';                    // Initialize array to store ACCs retrieved for a single query ID
